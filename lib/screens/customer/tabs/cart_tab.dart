...
class _CartTabState extends State<CartTab> {
  ...
  Future<void> _submitOrder() async {
    if (_nameCtrl.text.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Vui lòng điền đủ thông tin và chọn thanh toán'),
        ),
      );
      return;
    }
  ...
  void _showSuccessDialog() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text(
          'Đơn hàng từ giỏ hàng đã được gửi đi. Bạn có thể theo dõi trong mục Lịch sử.',
        ),
        actions: [
          FilledButton(
  ...
  Widget _buildSummary(CartProvider cart) {
    ...
    bool hasOutOfStock = cart.items.entries.any(
      (e) => menu.isOutOfStock(e.key.id, inventory),
    );
        ...
        children: [
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Giỏ hàng có món đã hết. Vui lòng xóa món hết hàng để tiếp tục.',
                      style: TextStyle(
                        color: Colors.red,
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
          ...
          SizedBox(
            ...
            child: FilledButton(
              ...
              child: const Text('Tiến hành đặt giao hàng'),
            ),
          ),
        ],
      ),
