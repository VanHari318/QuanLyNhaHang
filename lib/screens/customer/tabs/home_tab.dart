...
class HomeTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bestSellers = menuProvider.allItems.where((d) => d.isBestSeller).take(6).toList();
  ...
  Widget _buildAssistantCard(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CustomerChatbotScreen())),
      child: Container(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: NetworkImage('https://images.unsplash.com/photo-1555126634-323283e090fa?auto=format&fit=crop&w=800&q=80'),
          fit: BoxFit.cover,
        ),
      ),
      child: Container(
        ...
        child: const Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Đại Tiệc Lẩu Vị Lai', 
              style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
            Text('Giảm ngay 20% cho nhóm từ 4 người', 
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Center(
                    child: Text(cat.name.substring(0, min(2, cat.name.length)).toUpperCase(), 
          ...
          child: Column(
            ...
            children: [
              Expanded(
                child: Stack(
                  children: [
                    Image.network(dish.imageUrl, width: double.infinity, fit: BoxFit.cover),
                    Positioned(
                      top: 8, left: 8,
                      child: Container(
        ...
        children: [
          ...
          const Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Thành viên V-VIP', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                Text('Tích điểm ngay để nhận ưu đãi từ 5-10% cho mỗi hoá đơn.', 
