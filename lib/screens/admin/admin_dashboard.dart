                ...
                IconButton(
                  ...
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Đang cập nhật dữ liệu quản trị...'),
                ...
                background: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [cs.primary, const Color(0xFF8B0000)],
                          ...
                          Row(
                            children: [
                              ...
                              CircleAvatar(
                                ...
                                backgroundImage:
                                    (admin != null && admin.imageUrl.isNotEmpty)
                        ...
                        return GridView.count(
                          ...
                          children: [
                            DashboardCard(
                              ...
                              onTap: () =>
                                  _push(context, const DashboardStatsScreen()),
                            ),
                            DashboardCard(
              ...
              sliver: SliverGrid.count(
                ...
                children: [
                  ...
                  _ModuleCard(
                    ...
                    color: Colors.green,
                    onTap: () =>
                        _push(context, const ChatbotManagementScreen()),
                  ),
                  _ModuleCard(
                    ...
                    color: Colors.red,
                    onTap: () =>
                        _push(context, const RestaurantLocationScreen()),
                  ),
                  _ModuleCard(
                    ...
                    color: Colors.orange,
                    onTap: () =>
                        _push(context, const CustomerManagementScreen()),
                  ),
                ],
              ),
            ),
